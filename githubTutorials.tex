...
\item best use with \underline{Atom} or \underline{Sublime} text editor
\item \underline{Sublime Merge} or \underline{Github Desktop} is also a very decent choice
\end{itemize}
...
\item small website design
\begin{itemize}
\item simple text/code with hyper-links/references
\item code syntax highlight with support for a lot of languages
\end{itemize}
...
% \item hyper-reference and hyper-link are available
% \tiny
% \begin{lstlisting}
% See more in [the official problem statement](https://asmehackathon.github.io/download/Hackathon\%20Problem\%20Statement$\_$IDETC$\_$2021$\_$Final.pdf).
% \end{lstlisting}
% \normalsize
